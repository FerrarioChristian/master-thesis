...
and their formal representation through \textbf{graphs}. It then details
parsing mechanisms, syntax trees, and the \textbf{Tree-sitter} framework,
and concludes with the formal principles of \textbf{lexical scoping} and
...
\subsection{Type Systems and Type Hints}
