...
\begin{itemize}
  \item \textbf{Chapter \ref{ch:background}} reviews the foundational concepts
    of software dependencies, technical debt, architectural smells, graph-based
    architectural modeling, parsing technologies, and lexical scoping.
  \item \textbf{Chapter \ref{ch:related_work}} examines the multi-language
    analysis challenge, surveying traditional compiler tooling,
    language-agnostic
    syntax models, reference resolution graphs, and state-of-the-art dependency
