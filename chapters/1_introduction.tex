...
\begin{itemize}
  \item \textbf{Chapter \ref{ch:background}} reviews the foundational concepts
    of static analysis, technical debt, architectural smells, dependency graphs,
    parsing technologies, name resolution, and type systems.
  \item \textbf{Chapter \ref{ch:related_work}} surveys related work in
    multi-language static analysis, language-agnostic AST representations,
    name resolution models, and existing architectural tooling.
